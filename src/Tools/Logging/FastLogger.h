...
#define INIT(...) printf(ANSI_COLOR_BOLD_GREEN "INIT::" __FILE__ "::" STR(__LINE__) "\t" ANSI_COLOR_RESET ANSI_COLOR_GREEN __VA_ARGS__); printf(ANSI_COLOR_RESET "\n")
#define UNLOAD(...) printf(ANSI_COLOR_BOLD_MAGENTA "UNLOAD::" __FILE__ "::" STR(__LINE__) "\t" ANSI_COLOR_RESET ANSI_COLOR_MAGENTA __VA_ARGS__); printf(ANSI_COLOR_RESET "\n")